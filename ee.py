...
from tensorflow_datasets import features  # type: ignore[import-not-found]

from tensorflow_graphics.datasets.features import pose_feature  # type: ignore[import-not-found]
...
class Camera(features.FeaturesDict):
  ...
  def to_json_content(self):
    return {}
print("Camera class loaded successfully")